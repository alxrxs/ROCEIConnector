...
1. **Clone the repository:**
   ```bash
   git clone https://github.com/alxrxs/ROCEIConnector.git
   cd ROCEIConnector
   ```
...
- **SHA-512 hash verification**: Before `dlopen()`, the app computes and verifies the library hash against a whitelist of known-good versions. This prevents loading tampered or malicious libraries.
